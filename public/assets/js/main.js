$(function ($) {
    ...
    jQuery(document).ready(function () {
        ...
        if ($typed.length > 0) {
            $typed.typed({
                strings: ["Full-Stack PHP Developer", "Laravel Developer", "OpenCart Developer"],
                stringsElement: null,
                typeSpeed: 70,
                startDelay: 150,
                backSpeed: 40,
    ...
    $('.blog-title').on('click', function () {
        ...
        $.ajax({
            ...
            success: function (data){
                ...
                $('.blog-content .post-image').attr('src', data.image)
                $('.blog-content .post-title').html(data.title);
                $('.blog-content .post-content').html(data.content);
                $('.blog-content .post-meta .post-author').html(data.author);
                $('.blog-content .post-meta .post-date').html(data.created_at_convert);
            },
